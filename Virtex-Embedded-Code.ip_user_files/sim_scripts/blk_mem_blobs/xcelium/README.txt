...
#
# Generated by export_simulation on Sun Feb 13 10:13:11 -0500 2022
#
################################################################################
...
'-reset_run' switch to the './blk_mem_blobs.sh' script.

./blk_mem_blobs.sh -reset_run
...
./blk_mem_blobs.sh -noclean_files

For more information on the script, please type './blk_mem_blobs.sh -help'.
