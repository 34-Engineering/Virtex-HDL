...
#
# Generated by export_simulation on Tue Mar 15 21:41:35 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_python_to_blob.sh' script.

./fifo_python_to_blob.sh -reset_run
...
./fifo_python_to_blob.sh -noclean_files

For more information on the script, please type './fifo_python_to_blob.sh -help'.
