...
localparam PythonSPICommand powerUpSequenceRegisterUpload [144] = '{
    ...
    '{setExposureAddress   , 1, 16'd4000},//30000},	// Exposure_0 (following frames) //duplicated in DefaultVirtexConfig
    '{setExposureAddress+31, 1, 16'd4000},//30000},	// Exposure_1 (current frame)    //duplicated in DefaultVirtexConfig
