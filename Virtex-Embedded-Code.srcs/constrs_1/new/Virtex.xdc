...
set_property PACKAGE_PIN H12 [get_ports {USB_TCK}]
set_property PACKAGE_PIN H11 [get_ports {USB_TDI}]
set_property PACKAGE_PIN F12 [get_ports {USB_TDO}]
set_property PACKAGE_PIN D15 [get_ports {USB_TMS}]
...
set_property PACKAGE_PIN J5 [get_ports {CAM_CLK_P}]
set_property PACKAGE_PIN J4 [get_ports {CAM_CLK_N}]
set_property PACKAGE_PIN H2 [get_ports {CAM_SYNC_P}]
set_property PACKAGE_PIN H1 [get_ports {CAM_SYNC_N}]
set_property PACKAGE_PIN J3 [get_ports {CAM_DOUT_P[3]}]
set_property PACKAGE_PIN H3 [get_ports {CAM_DOUT_N[3]}]
set_property PACKAGE_PIN K1 [get_ports {CAM_DOUT_P[2]}]
set_property PACKAGE_PIN J1 [get_ports {CAM_DOUT_N[2]}]
set_property PACKAGE_PIN L3 [get_ports {CAM_DOUT_P[1]}]
...
set_property PACKAGE_PIN T9 [get_ports {CAM_SPI_MOSI}]
set_property PACKAGE_PIN T8 [get_ports {CAM_SPI_MISO}]
set_property PACKAGE_PIN T7 [get_ports {CAM_SPI_CLK}]
set_property PACKAGE_PIN R11 [get_ports {CAM_TRIG[2]}]
set_property PACKAGE_PIN P11 [get_ports {CAM_TRIG[1]}]
set_property PACKAGE_PIN R13 [get_ports {CAM_TRIG[0]}]
set_property PACKAGE_PIN R10 [get_ports {CAM_MON[0]}]
set_property PACKAGE_PIN N9 [get_ports {CAM_MON[1]}]
set_property PACKAGE_PIN P9 [get_ports {CAM_RESET}]
