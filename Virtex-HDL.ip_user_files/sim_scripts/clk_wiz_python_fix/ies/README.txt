...
#
# Generated by export_simulation on Wed Apr 20 18:21:10 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_python_fix.sh' script.

./clk_wiz_python_fix.sh -reset_run
...
./clk_wiz_python_fix.sh -noclean_files

For more information on the script, please type './clk_wiz_python_fix.sh -help'.
