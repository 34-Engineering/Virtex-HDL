...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Virtex-HDL.gen/sources_1/ip/clk_wiz_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Virtex-HDL.gen/sources_1/ip/clk_wiz_1" \
    "$ref_dir/../../../../Virtex-HDL.gen/sources_1/ip/clk_wiz_1/clk_wiz_1_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
