...
#
# Generated by export_simulation on Tue Mar 15 21:20:57 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_python_stream.sh' script.

./fifo_python_stream.sh -reset_run
...
./fifo_python_stream.sh -noclean_files

For more information on the script, please type './fifo_python_stream.sh -help'.
