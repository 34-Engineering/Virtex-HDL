...
#
# Generated by export_simulation on Wed Mar 16 15:46:31 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_virtex_config.sh' script.

./fifo_virtex_config.sh -reset_run
...
./fifo_virtex_config.sh -noclean_files

For more information on the script, please type './fifo_virtex_config.sh -help'.
