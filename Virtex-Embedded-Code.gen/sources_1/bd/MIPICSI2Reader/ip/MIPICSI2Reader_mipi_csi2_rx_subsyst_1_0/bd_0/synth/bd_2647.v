...
//--------------------------------------------------------------------------------
//Command: generate_target bd_2647.bd
//Design : bd_2647
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_2647,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2647,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "MIPICSI2Reader_mipi_csi2_rx_subsyst_1_0.hwdef" *) 
module bd_2647
   (cl_stopstate_intr,
    crc_status_intr,
    ctrl_core_en,
  ...
  assign video_out_tuser[63:0] = vfb_0_m_vfb_TUSER;
