...
HD_PWD='C:/Users/liamsnow/Documents/GitHub/Virtex-Embedded-Code/Virtex-Embedded-Code.runs/MIPICSI2Reader_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPICSI2Reader_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIPICSI2Reader_clk_wiz_0_0.tcl
